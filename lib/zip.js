...
class Zip {
	 ...
	 *
	 * @async
	 * @returns {Promise.<boolean>} - `true` if entry is symlink. Otherwise, false.
	 */
	async isSymlink() {
		const fileMode = await this._modeFromEntry();
	 ...
	 * @returns {Promise.<number>} - file mode
	 */
	async _modeFromEntry() {
